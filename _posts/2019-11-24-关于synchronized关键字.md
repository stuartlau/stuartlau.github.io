...
Constant pool:
   ...
   #2 = Fieldref           #3.#19         // SyncCodeBlock.i:I
   #3 = Class              #20            // SyncCodeBlock
...
Constant pool:
   ...
   #2 = Fieldref           #3.#15         // SyncMethod.i:I
   #3 = Class              #16            // SyncMethod
...
- 另外一种是当线程处于运行状态时，由于无法通过运行中的代码感知中断状态，需要自行主动去判断中断状态，并编写中断线程的代码
